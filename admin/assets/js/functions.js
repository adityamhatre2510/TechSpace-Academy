  ...
  var ThemeBuilder = (function () {
      ...
      if (windowSize < 991) {
        if ($(".rs-nav .menu-links").children("div").length == 0) {
          var logoData = jQuery("<div>")
            .append($(".rs-nav .logo-header").clone())
            .html();
          jQuery(".rs-nav .menu-links").prepend(logoData);
          jQuery(".rs-nav .menu-links .logo-header > a > img").attr(
            "src",
            "images/logo.png"
          );
          jQuery(".rs-nav.lw .menu-links .logo-header > a > img").attr(
            "src",
    ...
    var magnificPopupImageView = function () {
      ...
      if (checkSelectorExistence(".mfp-gallery")) {
        jQuery(".mfp-gallery").magnificPopup({
          /* mfp-gallery to  magnific-image*/
          delegate: ".mfp-link" /* magnific-anchor to  magnific-anchor*/,
          type: "image",
          tLoading: "Loading image #%curr%...",
          mainClass:
            "mfp-img-mobile" /* mfp-img-mobile to  magnific-img-mobile*/,
          gallery: {
            enabled: true,
    ...
    var pageScrollToTop = function () {
      ...
      jQuery("button.back-to-top").on("click", function () {
        /* change back-to-top to scrollToTop*/ jQuery("html").animate(
          { scrollTop: 0 },
          500
        );
        return false;
